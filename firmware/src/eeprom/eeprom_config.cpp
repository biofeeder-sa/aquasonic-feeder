...
void postInitConfig(void) {
  ...
  if ((VAR_WIRE_BYTE(VAR_AMP_WARN_X2, 2) == 0xFF) && (VAR_WIRE_BYTE(VAR_AMP_WARN_X2, 3) == 0xFF)) {
    VAR_WIRE_BYTE(VAR_AMP_WARN_X2, 2) = 0x02;
    VAR_WIRE_BYTE(VAR_AMP_WARN_X2, 3) = 0xBC;
  }
  if ((VAR_WIRE_BYTE(VAR_AMP_WARN_X3, 2) == 0xFF) && (VAR_WIRE_BYTE(VAR_AMP_WARN_X3, 3) == 0xFF)) {
    VAR_WIRE_BYTE(VAR_AMP_WARN_X3, 2) = 0x02;
    VAR_WIRE_BYTE(VAR_AMP_WARN_X3, 3) = 0xBC;
  }
